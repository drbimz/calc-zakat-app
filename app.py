    ...
    if st.button("Hitung Zakat"):
        ...
        if total_penghasilan >= nishab:
            st.success(f"Alhamdulillah kak {nama}, kamu sudah wajib zakat yaa 🙌 "
                       "Mau transfer atau lewat digital, kini lebih mudah. Tinggal klik link di bawah ini yaa.")
