    ...
    st.markdown(
        ...
        <div class="chat-bubble">
            ...
            <div class="chat-message bot">
                ...
                Aku Raju, Kang Amil dari BAZNAS Kabupaten Banyumas. Salam kenal ya kak.<br>
                Ini adalah mini aplikasi resmi milik BAZNAS Kabupaten Banyumas untuk hitung cepat zakat.<br>
        ...
        st.markdown(
            ...
            <div class="chat-bubble">
                ...
                <div class="chat-message bot">
                    ...
                    Total Penghasilan: Rp {total_penghasilan:,}<br>
                    Besaran Zakat (2.5%): Rp {besaran_zakat:,.2f}<br>
                    Nishab Zakat: Rp {nishab:,}
                </div>
            </div>
            """,
            unsafe_allow_html=True
